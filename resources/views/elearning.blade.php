@include ('header');
                ...
                <ul class="navbar-nav ml-auto" >
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="{{url('blog')}}" >Blog</a>
                         ...
                         <li class="nav-item">
                        <a class="nav-link text-dark font-weight-bold" href="{{url('register')}}" >E-Learning</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('contact')}}" >Contact</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a href="components.html" class="nav-link dropdown-toggle btn btn-light btn-sm rounded  text-info" data-toggle="dropdown"><i class="fa fa-user text-info"></i></a>
 ...
 <!-- Page Header -->
    <header class="elearningimage">
        <div class="overlay">
             <h5 class="font-weight-bold text-center" style="font-size: 30px; font-family: Gebriola"><span class="text-info"> E-LEARNING</span></h5>
